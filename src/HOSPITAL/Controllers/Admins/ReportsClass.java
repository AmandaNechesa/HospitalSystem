...
public class ReportsClass extends Super {
    ...
    public void diseaseStats() {
        ...
        try {
            outfile = new PrintWriter(System.getProperty("user.home") + "\\Desktop\\reports\\Report.txt");//output file
...
//                drawPieChart(keys,values, new String[]{"DISEASES CHART"});
                writeChartToPDF(generatePieChart(keys, values, new String[]{"DISEASES CHART"}), width / 2, height / 2, System.getProperty("user.home") + "\\Desktop\\reports\\REPORT.pdf");
