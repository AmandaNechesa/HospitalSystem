...
import static HOSPITAL.Controllers.settings.APPLICATION_ICON;
import static HOSPITAL.Controllers.settings.appName;
            ...
            public void handle(MouseEvent event) {
                ...
                try {
                    if (isInternetAvailable()) {
                        ...
                        try {
                            panel.getChildren().setAll(Collections.singleton(FXMLLoader.load(Objects.requireNonNull(getClass().getClassLoader().getResource("HOSPITAL/resources/views/basic/Help.fxml")))));
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    } else {
...
//                                    go to admin panel
                                    ...
                                    panel.getChildren().setAll(Collections.singleton(FXMLLoader.load(Objects.requireNonNull(getClass().getClassLoader().getResource("HOSPITAL/resources/views/Admins/panel.fxml")))));
                                    assert false;
...
//                                    go to admin panel
                                    ...
                                    settings.id.put("userid", resultSet.getString("id"));
                                    settings.hospital.put("hospital_name", resultSet.getString("hospital"));
                                    panel.getChildren().setAll(Collections.singleton(FXMLLoader.load(Objects.requireNonNull(getClass().getClassLoader().getResource("HOSPITAL/resources/views/labtechnician/panel.fxml")))));
                                    assert false;
//                                    work as sessions and hold user session data
...
//                                user is not admin go to doctor panel
                                ...
                                try {
                                    ...
                                    panel.getChildren().setAll(Collections.singleton(FXMLLoader.load(Objects.requireNonNull(getClass().getClassLoader().getResource("HOSPITAL/resources/views/Physicians/panel.fxml")))));
                                    assert false;
                                    //                                    work as sessions and hold user session data
                                    assert false;
//                                    work as sessions and hold user session data
...
//                                user is not admin go to receptionist panel
                                ...
                                try {
                                    ...
                                    panel.getChildren().setAll(Collections.singleton(FXMLLoader.load(Objects.requireNonNull(getClass().getClassLoader().getResource("HOSPITAL/resources/views/Receptionist/panel.fxml")))));
                                    assert false;
                                    //                                    work as sessions and hold user session data
                                    assert false;
//                                    work as sessions and hold user session data
